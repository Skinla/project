...
try {
    ...
    if (!file_exists($cacheManagerPath)) {
        $cacheManagerPath = __DIR__ . '/universal-system/cache_manager.php';
    }
    
    if (!file_exists($cacheManagerPath)) {
        throw new Exception("Файл cache_manager.php не найден. Проверенные пути: " . __DIR__ . '/cache_manager.php, ' . __DIR__ . '/../cache_manager.php, ' . __DIR__ . '/universal-system/cache_manager.php');
    }
