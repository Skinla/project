...
try {
    ...
    if (!file_exists($databasePoolPath)) {
        $databasePoolPath = __DIR__ . '/universal-system/database_pool.php';
    }
    
    if (!file_exists($databasePoolPath)) {
        throw new Exception("Файл database_pool.php не найден. Проверенные пути: " . __DIR__ . '/database_pool.php, ' . __DIR__ . '/../database_pool.php, ' . __DIR__ . '/universal-system/database_pool.php');
    }
