...
class ErrorHandler {
    ...
    public function addElementToIblock54($elementData, $normalizerFile = null) {
        ...
        try {
            ...
            $iblockId = $this->config['iblock']['iblock_54_id'] ?? 54;
            ...
            if ($normalizerFile) {
                $properties['PROPERTY_388'] = $normalizerFile;
            }
            
            // PROPERTY_199 (siteId для CallTouch)
            if (isset($elementData['siteId'])) {
                $properties['PROPERTY_199'] = $elementData['siteId'];
            }
            ...
            if (!empty($properties)) {
                CIBlockElement::SetPropertyValues($elementId, $iblockId, $properties);
            }
